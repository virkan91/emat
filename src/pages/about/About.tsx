        ...
        <div className="container max-w-[1250px] mx-auto p-[20px] h-full ">
          ...
          <div className="h-full flex items-center mt-[10px]">
            <div className="max-w-[480px] ">
              <h1 className="text-[50px] font-bold	not-italic	text-[#FFF] leading-[60px] dark:text-orange-500 animate__animated animate__backInDown">
                {t("Haktext.h1")}
                {/* Yenilikle Geleceği İnşa Ediyoruz */}
              </h1>
              <p className="text-[#FFF] mt-[30px] dark:text-orange-400">
                {t("Haktext.p")}
              </p>
            </div>
          </div>
        ...
        <div className="container max-w-[1250px] m-auto p-[20px]">
          <div className="grid md:grid-cols-2 md:gap-20 grid-cols-1 gap-0">
            ...
            <div className=" flex flex-col gap-[20px] max-w-[480px]  ">
              <h4 className="text-[#FF8A00] text-[12px] font-semibold animate__animated animate__backInRight">
                {t("sec2.p")}
              </h4>
              <h2>{t("sec2.h2")}</h2>
